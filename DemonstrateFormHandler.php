...
<div class="p-2"><h1>WDV101 Intro HTML and CSS</h1></div>
<div class="p-2"><h2>UNIT 3 Forms - Lesson 2 Server Side Processes</h2></div>
</div>
    <!-- Original Instructions and Content left for review
...
<h2>Dear <strong><?php echo $_POST['first_name']; ?></strong>,</h2><br>
<div class="card body">
<p>Thank for you for your interest in DMACC.<br> </div>
<div class="card-body border-secondary mb-3">
We have you listed as a <strong><?php
if (isset($_POST['School_Year'])){
echo $_POST['School_Year'];} ?></strong> starting this fall. <br> 
You have declared <strong> <?php 
if (isset($_POST['programs'])){echo $_POST['programs'];}?></strong> as your major. <br> 
Based upon your responses we will provide the following information in our confirmation email to you at <strong><?php echo $_POST['customer_email']; ?></strong>.:<br><br><div class="card body">
<strong><?php if (isset($_POST['Contact'])){
echo $_POST['Contact'];}?>
<br> 
<?php if (isset($_POST['Advisor'])){
echo $_POST['Advisor'];}?> <br></strong>
</div>
You have shared the following comments which we will review:<br> <br><div class="card body">
<strong><?php if (isset($_POST['Comments'])){
echo $_POST['Comments'];}?></strong></p>
</div>
</div>
</div>
